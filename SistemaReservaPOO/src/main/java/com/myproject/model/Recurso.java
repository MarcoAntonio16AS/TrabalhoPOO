...
//==============================================================================
    ...
    public Recurso(String nome_recurso, String tipo_recurso, int id_recurso, 
                   double preco_recurso, int cap_recurso, boolean disponivel) {
...
//==============================================================================
    ...
    public double getPreco_recurso() {
        return preco_recurso;
    }

    public void setPreco_recurso(double preco_recurso) {
        this.preco_recurso = preco_recurso;
    }
